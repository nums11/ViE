    ...
    <router-link :to="{name: 'meeting_info', params: { meeting_id: meeting._id }}">
      <div class="pill-container">
        ...
        <div class="right-side">
          ...
          <div v-if="meeting.has_async_portion && meeting.async_portion.videos.length > 0" class="icon-area"><img src="@/assets/icons/003-play-button.svg" width="100%" height="100%"/></div>
