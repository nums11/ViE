  ...
  <div>
    ...
    <form class="new-lecture-form" @submit.prevent="createMeeting">
      <div class="form-group">
        ...
        <button @click="canMeetingBeCreated" class="btn btn-primary create-lecture-btn" :disabled="!meetingCanBeCreated">Create Meeting</button>
      </div>
    </form>
  </div>
</template>
...
export default {
  ...
  methods: {
    canMeetingBeCreated () {
      console.log(`Meeting can be created ? ${this.meetingCanBeCreated}`)
    },
